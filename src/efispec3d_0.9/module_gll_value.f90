...
!>@param gll_all_values      : all GLL values of array ordered by global GLL nodes numbering
...
!***********************************************************************************************************************************************************************************
      ...
      real   , intent( in), dimension(IG_NDOF,ig_ngll_total)           :: gll_all_values
      integer, intent( in), dimension(        IG_NGLL,IG_NGLL,IG_NGLL) :: gll_global_number
      real   , intent(out), dimension(IG_NDOF,IG_NGLL,IG_NGLL,IG_NGLL) :: gll_selected_values
      ...
      do k = 1,IG_NGLL
         do l = 1,IG_NGLL
            do m = 1,IG_NGLL
               ...
               gll_selected_values(1,m,l,k) = gll_all_values(1,igll)
               gll_selected_values(2,m,l,k) = gll_all_values(2,igll)
               gll_selected_values(3,m,l,k) = gll_all_values(3,igll)
...
!>@param gll_selected_values : selected GLL values ordered by local GLL nodes numbering
!***********************************************************************************************************************************************************************************
   subroutine get_quad_gll_value(gll_all_values,gll_global_number,gll_selected_values)
!***********************************************************************************************************************************************************************************
      ...
      real   , intent( in), dimension(IG_NDOF,ig_ngll_total)   :: gll_all_values
      integer, intent( in), dimension(        IG_NGLL,IG_NGLL) :: gll_global_number
      real   , intent(out), dimension(IG_NDOF,IG_NGLL,IG_NGLL) :: gll_selected_values
      ...
      do k = 1,IG_NGLL
         do l = 1,IG_NGLL
            ...
            gll_selected_values(1,l,k) = gll_all_values(1,igll)
            gll_selected_values(2,l,k) = gll_all_values(2,igll)
            gll_selected_values(3,l,k) = gll_all_values(3,igll)
...
!***********************************************************************************************************************************************************************************
   end subroutine get_quad_gll_value
!***********************************************************************************************************************************************************************************
