...
!***********************************************************************************************************************************************************************************
       ...
       if (LG_ASYNC_MPI_COMM) then
           ...
           ios = init_array_int(ig_mpi_buffer_offset,ig_ncpu_neighbor+1,"ig_mpi_buffer_offset")
...
!----->allocate array for mpi buffers
       if (LG_ASYNC_MPI_COMM) then
          ...
          ios = init_array_real(rg_mpi_buffer_send,ig_ncpu_neighbor+1,"rg_mpi_buffer_send")

          ios = init_array_real(rg_mpi_buffer_recv,ig_ncpu_neighbor+1,"rg_mpi_buffer_recv")
...
!***********************************************************************************************************************************************************************************
       ...
       real   , intent(in), dimension(IG_NDOF*max_size)   :: gll_coord_send
       real   , intent(in), dimension(IG_NDOF*max_size)   :: gll_coord_recv
